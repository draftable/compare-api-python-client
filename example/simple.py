...
if base_url and not base_url.endswith('/v1'):
    sys.stderr.write('Value for DR_BASE_URL is "%s" but must end with "/v1"\n' % base_url)
    sys.exit(1)
...
# Alternatively, be explicit about "type" (RTF, PDF, etc) and display name:
comparison = comparisons.create(
    left=draftable.make_side('https://api.draftable.com/static/test-documents/code-of-conduct/left.rtf', 'rtf'),
    right=draftable.make_side('https://api.draftable.com/static/test-documents/code-of-conduct/right.pdf', 'pdf'),
)
